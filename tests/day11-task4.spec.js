...
await page.locator("//p[@data-cy='ocs-text-module']").click()
    ...
    let b = await page.locator("//span[@class='Medal-styles_Medal-sc-645148e1-1 fqHqIZ'][@data-cy='medal-main']/span[@data-cy='ocs-text-module'][@class='OcsText-styles_StyledText-sc-bf256156-0 cjPVFu text--sm-body'][text()='2']").nth(2).textContent()
    console.log(b);
